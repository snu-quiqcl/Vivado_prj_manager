...
EdgeCounter EdgeCounter_4;
EdgeCounter EdgeCounter_5;
EdgeCounter EdgeCounter_6;
EdgeCounter EdgeCounter_7;
EdgeCounter EdgeCounter_8;
EdgeCounter EdgeCounter_9;
TTL_out ttl_out_0;
TTL_out ttl_out_1;
TTL_out ttl_out_2;
TTL_out ttl_out_3;
...
void init_rfsoc(){
    ...
    EdgeCounter_4.set_addr(XPAR_EDGECOUNTER_4_BASEADDR);
    EdgeCounter_4.flush_fifo();
    EdgeCounter_5.set_addr(XPAR_EDGECOUNTER_5_BASEADDR);
    EdgeCounter_5.flush_fifo();
    EdgeCounter_6.set_addr(XPAR_EDGECOUNTER_6_BASEADDR);
    EdgeCounter_6.flush_fifo();
    EdgeCounter_7.set_addr(XPAR_EDGECOUNTER_7_BASEADDR);
    EdgeCounter_7.flush_fifo();
    EdgeCounter_8.set_addr(XPAR_EDGECOUNTER_8_BASEADDR);
    EdgeCounter_8.flush_fifo();
    EdgeCounter_9.set_addr(XPAR_EDGECOUNTER_9_BASEADDR);
    EdgeCounter_9.flush_fifo();
