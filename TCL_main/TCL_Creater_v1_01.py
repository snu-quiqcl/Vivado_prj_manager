...
class TCL_maker:
    ...
    def generate_xilinx_block_design(self, folder_directory, prj_name):
        ...
        tcl_code += 'set vout00_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:diff_analog_io_rtl:1.0 vout00_0 ]\n'
...
set_property -dict [ list \
   ...
   CONFIG.SUBPRESET1 {Custom} \
    ...
    def make_RFSoC_main_tcl(self, folder_directory,prj_name,part_name,board_path,board_name,src_folder_directory,file_type):
        file_name = prj_name+".tcl"
        print(file_name)
        # Combine the file name and folder directory to create the full file path
        file_path = folder_directory + '\\' + file_name
...
if __name__ == "__main__":
    ...
    ###########################################################################
    prj_name = "RFSoC_Main"
    folder_directory = "C:\Jeonghyun\GIT\RFSoC\RFSoC_Design_V1_1\IP_File_00\RFSoC_Main"
    src_folder_directory = "C:\Jeonghyun\GIT\RFSoC\RFSoC_Design_V1_1\IP_File_00\RFSoC_Main"
    part_name = "xczu28dr-ffvg1517-2-e"
    board_path = "C:/Xilinx/Vivado/2020.2/data/boards/board_files"
    board_name = "xilinx.com:zcu111:part0:1.4"
    file_type = [".v", ".sv", ".xci"]
    tcl.make_RFSoC_main_tcl(folder_directory,prj_name,part_name,board_path,board_name,src_folder_directory, file_type)
