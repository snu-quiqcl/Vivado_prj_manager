...
"""
import TCL_main.TCL_Creater_v1_01 as prj_mgr
import sys
import os
...
class VivadoPrjMgrMainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.tcl_maker = prj_mgr.TCL_maker()
    ...
    def MakeProject_Clicked(self):
        self.tcl_maker.run(self.folder_directory,self.prj_name,self.part_name,self.board_path,self.board_name,self.file_type,self.vivado_path, self.file_path)
