...
def Convert2json(input_str):
    ...
    pattern = r"CONFIG\.([\w\.]+)\s+string\s+false\s+(\w+)"
...
CONFIG.Component_Name                               string   false      fifo_generator_1
CONFIG.DATA_WIDTH                                   string   false      64
CONFIG.Data_Count                                   string   false      false
CONFIG.Data_Count_Width                             string   false      9
...
CONFIG.Full_Threshold_Assert_Value                  string   false      511
...
CONFIG.Full_Threshold_Negate_Value                  string   false      510
...
CONFIG.Input_Depth                                  string   false      512
...
CONFIG.Output_Depth                                 string   false      512
CONFIG.Output_Register_Type                         string   false      Embedded_Reg
CONFIG.Overflow_Flag                                string   false      true
...
CONFIG.Read_Data_Count_Width                        string   false      9
...
CONFIG.Reset_Type                                   string   false      Asynchronous_Reset
...
CONFIG.Use_Dout_Reset                               string   false      false
...
CONFIG.Write_Data_Count_Width                       string   false      9
