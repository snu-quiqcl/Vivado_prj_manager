...
set RFMC_DAC_00_P [ create_bd_port -dir O RFMC_DAC_00_P ]
        """
        tcl_code += 'set DAC_Controller_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:DAC_Controller:1.0 DAC_Controller_0 ]\n'
        tcl_code += 'set proc_sys_reset_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_0 ]\n'
        tcl_code += 'set TimeController_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:TimeController:1.0 TimeController_0 ]\n'
        tcl_code += """
