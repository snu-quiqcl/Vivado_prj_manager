...
class Verilog_maker:
    def __init__(self):
        ...
        self.dac_controller_fifo_depth = 256
    ...
    def generateXilinxDspFullSum(self, folder_directory, dsp_name):
        ...
        tcl_code += f' CONFIG.pipeline_options {{Expert}} CONFIG.creg_3 {{false}} CONFIG.creg_4 {{false}}'
        tcl_code += f' CONFIG.creg_5 {{false}} CONFIG.concatreg_3 {{false}}'
    ...
    def makeDacControllerTCL(self, folder_directory,prj_name,part_name,board_path,board_name,src_folder_directory,file_type):
        ...
        self.tcl_commands += self.generateXilinxDspFullSum(folder_directory, 'xbip_dsp48_sum_macro_1')
